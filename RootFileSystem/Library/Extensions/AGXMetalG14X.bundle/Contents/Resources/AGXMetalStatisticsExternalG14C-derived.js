...
{
    return VSInvocation() / (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_vtx * TIME_SCALE);
}
...
{
    return PrimitivesSubmitted() / (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_vtx * TIME_SCALE);
}
...
{
    return PSInvocation() / (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_frg * TIME_SCALE);
}
...
{
    return Math.max(_7cef4e481233623472ea3e1f6b4131fabb20f247f7e5eae173dfd693aa60d0ff - _9177fce9b3d9e2a64a816854b3084588e4673c25a1c069c53b5909a77fb853eb, 0.0) * 32 + _9177fce9b3d9e2a64a816854b3084588e4673c25a1c069c53b5909a77fb853eb * TileWidth * TileHeight;
}
...
{
    return Math.min((LossyCompressedSamples() * 100.0) / Math.max(TextureQuads() * 4, 1.0), 100.0);
}
...
{
    return Math.max(TextureQuads()*4 - (CompressedSamples() + LosslessCompressedSamples() + LossyCompressedSamples()), 0);
}
...
// name: Percentage of Lossy Compressed Pixels Written to Memory
// description: Percentage of number of lossy compressed pixels written to memory
// type: Percentage
function LossyCompressedPixelsWrittenToMemoryPercent()
{
    return 100.0 * LossyCompressedPixelsWrittenToMemory() / Math.max(PixelsWrittenToMemory(), 1.0);
}
...
{
    return 64.0 * (_f539a056fbd45e39d61b9d34af0ea1a305dd8af6f005b5aa29488f2c966e7f21_vtx + _c420303ee3c2ea941491fa0a071ec1553251898524fce318c3635bc711160395_vtx);
}
...
{
    return 64.0 * (_f539a056fbd45e39d61b9d34af0ea1a305dd8af6f005b5aa29488f2c966e7f21_frg + _c420303ee3c2ea941491fa0a071ec1553251898524fce318c3635bc711160395_frg);
}
...
{
    return 64.0 * (_c89f25b2a31116ea6540fc6b89b623da7d4cbc9b2349ce7dbe4423a1395da60a_vtx + _7eba0657c66c2437c8d6952fb82117b9399d920ea84fa32c5bdc9d1dee49e290_vtx);
}
...
{
    return 64.0 * (_c89f25b2a31116ea6540fc6b89b623da7d4cbc9b2349ce7dbe4423a1395da60a_frg + _7eba0657c66c2437c8d6952fb82117b9399d920ea84fa32c5bdc9d1dee49e290_frg);
}
...
{
    return 64.0 * (_c89f25b2a31116ea6540fc6b89b623da7d4cbc9b2349ce7dbe4423a1395da60a + _7eba0657c66c2437c8d6952fb82117b9399d920ea84fa32c5bdc9d1dee49e290);
}
...
{
    return 64.0 * ((_98377c7025232eca04b5a5004ac615738cddebb0841f77d81c056a37d784cf20_vtx) + Math.max(_3c6dba64fd85b35b8b8339f1d322943087d45cbb9b6689c587fd76259587a9d8_vtx - _ac73411a986e90adcd0a1181ace1f2684e4a900be931343385b93f58de650db4_vtx, 0.0));
}
...
{
    return 64.0 * ((_98377c7025232eca04b5a5004ac615738cddebb0841f77d81c056a37d784cf20_frg) + Math.max(_3c6dba64fd85b35b8b8339f1d322943087d45cbb9b6689c587fd76259587a9d8_frg - _ac73411a986e90adcd0a1181ace1f2684e4a900be931343385b93f58de650db4_frg, 0.0));
}
...
{
    return 64.0 * ((_98377c7025232eca04b5a5004ac615738cddebb0841f77d81c056a37d784cf20) + Math.max(_3c6dba64fd85b35b8b8339f1d322943087d45cbb9b6689c587fd76259587a9d8 - _ac73411a986e90adcd0a1181ace1f2684e4a900be931343385b93f58de650db4, 0.0));
}

// name: Parameter Manager Writes To Main Memory
// description: Total parameter manager writes to main memory
// type: Value
function TotalPMBytesWrittenToMainMemory()
{
    return 64.0 * _a31cb764db94a67880e186b0fc9e1d9d13e2c06b08db3167a5475cb75163781d;
}

// name: Parameter Manager Reads From Main Memory
// description: Total parameter manager reads from main memory
// type: Value
function TotalPMBytesReadFromMainMemory()
{
    return 64.0 * _521de75bc49981f7ab61d82d53a01d20ce2675553dff5b641a368059601177b1;
}

// name: AMCC Miss rate
// description: AMCC Miss Rate
// type: Percentage
function AMCCMissRate()
{
    return 100.0 * _5bf327fbf92d6d830e7db2251672fe44ff2cedf9734ca865292239a80abfc3c1 / Math.max(1.0, _ffd56ac933559d4f32b26f7eca04167eda4edc022684974ecc0e7f7d2a03b5fe + _5bf327fbf92d6d830e7db2251672fe44ff2cedf9734ca865292239a80abfc3c1);
}
...
// name: Buffer L1 Bytes Read PreCoalesced
// description: Total bytes read from buffer L1 cache precoalesced
// type: Value
function TotalBytesReadFromBufferL1CachePreCoalesced()
{
    return _15a728e0d87e7438047dff701a00bca120eb6cedbf5ccb5e5883257d942dc0b5 * 512.0;
}

// name: Buffer L1 Bytes Stored PreCoalesced
// description: Total bytes written from buffer L1 cache precoalesced
// type: Value
function TotalBytesWrittenToBufferL1CachePreCoalesced()
{
    return _1e25a978d2209bf96465453182236eab8c7f0174aa25f4471165c282f5f72ef9 * 128.0;
}
...
// name: LM Bytes read PreCoalesced
// description: Total bytes read from buffer L1 cache precoalesced
// type: Value
function TotalBytesReadLMPreCoalesced()
{
    return (_26dad2ac056dff3c59d33fbb01963767d1f7f0fd3c2e622c29118fd02ac8f9cc + _b5e2e4b2dbde4e642bed15fbd046d4ddbb2b908f9bd5c9316805d3bc027c2158) * 128.0;
}

// name: UFC Accesses
// description: UFC
// type: Value
function UFCReadWrites()
{    
    return (_c901ce5522fffc0b3eeecb5f2e3070608960b74ec25f849205c4fc446aa7f28a) * 4.0;
}

// name: TSC Accesses
// description: TSC
// type: Value
function TSCReadWrites()
{    
    return (_7e4bc1c317a2c2f7acfcde01c84cc45b3390881611c20e214b46be33f8a4e3cb) * 4.0;
}

// name: SSC Accesses
// description: SSC
// type: Value
function SSCReadWrites()
{    
    return (_27699a04e9a065656cd0ff96f5a90ac8c984135d8f0d5ff1e8a0a190ccb02a27) * 4.0;
}
...
{
    return (VSBytesReadFromMainMemory() + VSBytesWrittenToMainMemory()) / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_vtx * TIME_SCALE));
}
...
{
    return (FSBytesReadFromMainMemory() + FSBytesWrittenToMainMemory()) / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_frg * TIME_SCALE));
}
...
{
    return (BytesReadFromMainMemory() + BytesWrittenToMainMemory()) / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e * TIME_SCALE));
}
...
{
    return VSALUInstructions() / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_vtx * TIME_SCALE));
}
...
{
    return FSALUInstructions() / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_frg * TIME_SCALE));
}
...
{
    return CSALUInstructions() / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e_cmp * TIME_SCALE));
}
...
{
    return 64.0 * _fa7f16c60620d451db8d71e3b82cab7253d2dbf1457c7966dbf002da9af010c0;
}
...
{
    return 64.0 * _fa7f16c60620d451db8d71e3b82cab7253d2dbf1457c7966dbf002da9af010c0_vtx;
}
...
{
    return 64.0 * _fa7f16c60620d451db8d71e3b82cab7253d2dbf1457c7966dbf002da9af010c0_frg;
}
...
{
    return 64.0 * (_e06b821bba710b56a3eaf194be742a6d964b111bb761426f6b1ebd16e227010e + _becc55001438de226fddc3e26ffa180fce103d635eb0f85ffbb6c01dbde954fd);
}
...
{
    return 64.0 * (_e06b821bba710b56a3eaf194be742a6d964b111bb761426f6b1ebd16e227010e_vtx + _becc55001438de226fddc3e26ffa180fce103d635eb0f85ffbb6c01dbde954fd_vtx);
}
...
{
    return 64.0 * (_e06b821bba710b56a3eaf194be742a6d964b111bb761426f6b1ebd16e227010e_frg + _becc55001438de226fddc3e26ffa180fce103d635eb0f85ffbb6c01dbde954fd_frg);
}
...
{                
    return 64.0 * (_c788b8bd5d3e1ef8ad9501833f3b01bba5e1046e3e16d1a2aa837b76a60f19f4 + _4167773bd45e5e4d7f626a716b9775f840b172225798dd96b00c6f7f0290d75e) + 128.0 * _67d62b746943a02f8d4dc07a8183667897d2a5b27b2bb6fbb52cc1f27f1c53f7;
}
...
{
    return 64.0 * _b89bac942f8b36ffc2ca66b71168fcbc6ce13aaf07ffbb371c8176139128528d;
}
...
{
    return (_5c5c55d05fb355aa5be61ac63c88eb4a2a521a47dd8f79c18b5c1df163d5cb55_norm + _c9bcd5df6397dc8477a12ddf9358bccbbb3d8e52fc3dadab320be9bbb14fe157_norm) / (8.0 * num_mgpus);
}
...
{    
    return BytesReadFromMainMemory() / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e * TIME_SCALE));
}   
...
{    
    return BytesWrittenToMainMemory() / Math.max(1, (_792173079ffc5aacc2cea817d8812166e71ea17309e294d24ee2cc88d2fb1e8e * TIME_SCALE));
}   
...
{    
    return _5c5c55d05fb355aa5be61ac63c88eb4a2a521a47dd8f79c18b5c1df163d5cb55_norm / (8.0 * num_mgpus);
}
...
{
    return BytesReadFromMainMemory() + BytesWrittenToMainMemory();
}
...
function MMULimiter()
{
    return Math.min((_6d6a7c8efb15986fa71f8bf4a6a06f8942199b36680e516766e92490607c958d_norm + _fdc48a2370f6885da6ac169661812057de2cf71fbbbcb5df8348a78f112992dc_norm) / (8.0 * num_mgpus), 100.0);
}
...
{
    return Math.min((_6d6a7c8efb15986fa71f8bf4a6a06f8942199b36680e516766e92490607c958d_norm) / (8.0 * num_mgpus), 100.0);
}
...
{                
    return 64.0 * (_95457b9a60a638f3c652d16526373338287f19e3cb86adaea8a30e8255a7aa34) + 128.0 * (_2b086decbf8af5fc652f38631028061547de9b4eab238b05cc6e26e20ba26444);
}
...
{
    return 64.0 * (_0f67618fe6dd59b9cc951584dc80dd9f5dd9c428402dbe2e8a03c7df4100020e);
}
...
// type: Percentage
function TLBMissRate()
{
    return 100.0 * _20c8b2b1747ee9c33baf87dc32e8f5d07b9eb25ca5829ad056d92eb0d040c76a / Math.max(_e247689f0b49c692ba39d348957d19faa7587b07d3025f3b283a165cfc35f5b8, 1.0);
} 
...
{
    return _e247689f0b49c692ba39d348957d19faa7587b07d3025f3b283a165cfc35f5b8;
}
...
function MMUTLBHits()
{
    return _e263044475c736413734a34bbc76c45c46960ed823cfa5696235ee862ce5b6ea;
}

// name: MMU TLB Miss Rate
// description: MMU TLB Miss Rate
// type: Percentage
...
function MissBufferFullStallRatio()
{
    ...
    {
        return Math.min(_e6362c1fcf78a3882ad4f3bbd5a66cfb0a6feeae2d8e84b4b161234e0b3aa335 / Math.max(_fdc48a2370f6885da6ac169661812057de2cf71fbbbcb5df8348a78f112992dc, 1.0), 1.0);
    }
    return 0;
}
